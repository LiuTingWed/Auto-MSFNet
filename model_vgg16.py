...
class Featurefusioncell43(nn.Module):
    ...
    def forward(self, fea, lowfeature):
        ...
        if levelfusion.size()[2:] != self.standardShape:
            levelfusion = F.interpolate(levelfusion, self.standardShape, mode='bilinear')
...
class Network_vgg16(nn.Module):
    ...
    def forward(self, input):
        h_, h_nopool2, h_nopool3, h_nopool4 = self.vgg16(input)
